...
# 3.1619, 2
    ...
    ppc["gencontrol"] = array([
            [ 1          , 3          , 0.001592   , 0.159155   , 0.007958   , 0.795775   , -7.5       , 7.5        ],
            [ 2          , 3          , 0.00191    , 0.190986   , 0.009549   , 0.95493    , -9.0       , 9.0        ],
            [ 3          , 3          , 0.001719   , 0.171887   , 0.008594   , 0.859437   , -8.1       , 8.1        ]
    ])
    ...
    # ppc["clique_tree"] = {
    # 'node': {1:[1, 4], 2:[3, 6], 3:[2, 8],4:[4, 5, 6, 7],5:[4, 7, 8, 9]},
    # 'edge': [ [1,4],[4,2],[4,5],[5,3] ],
    # 'node_gl': {1:[1], 2:[3], 3:[2],4:[5, 7],5:[7, 9]},
    # }
